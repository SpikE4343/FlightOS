...
//-----------------------------------------------------------------------------
	...
	struct ProfileManager {
		...
		SHINY_INLINE const char* outputNodesAsString(void) { return OutputNodesAsString(&rootNode, nodeCount); }
		SHINY_INLINE const char* outputZonesAsString(void) { return OutputZonesAsString(&rootZone, zoneCount); }
